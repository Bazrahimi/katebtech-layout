...
>(function Button(props, ref) {
  ...
  const variants: Record<ButtonVariant, string> = {
    primary:
      "bg-app-s-main text-white hover:bg-app-s-light focus:ring-app-s-dark",
    secondary:
      "bg-app-p-main text-white hover:bg-app-p-light focus:ring-app-p-dark",
    danger: "bg-red-600 text-white hover:bg-red-500 focus:ring-red-300",
    outline:
      "border border-app-p-main bg-white text-app-p-main hover:bg-app-p-light focus:ring-app-p-dark",
  };
