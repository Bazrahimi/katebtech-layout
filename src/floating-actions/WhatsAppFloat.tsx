 ...
 */
export const WhatsAppFloat = ({ textHeading, whatsAppNumber }: Props) => {
  return (
    <div className="fixed right-5 bottom-5 z-50">
      <Link
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition-transform hover:scale-105 focus:ring-2 focus:ring-offset-2 focus:outline-none"
      >
