...
export const PoweredByKateb = ({ orgName, className }) => {
    ...
    return (_jsxs("div", { className: cn("mt-3 flex flex-wrap items-center justify-center gap-2 text-xs text-slate-200", className), children: [_jsxs("span", { children: ["\u00A9 ", year, " ", orgName, ". All rights reserved."] }), _jsx("span", { className: "opacity-40", children: "|" }), _jsxs("a", { href: "https://www.katebtech.com.au", target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 rounded-full bg-[#0b3d2e] px-3 py-1 text-white ring-1 ring-white/15 transition hover:bg-[#10513e] focus:ring-2 focus:ring-[#f59e0b] focus:ring-offset-2 focus:ring-offset-[#0b3d2e] focus:outline-none", children: [_jsx(Image, { src: KATEB_TECH_LOGO, alt: "Kateb Tech logo", width: 16, height: 16, unoptimized: true }), _jsxs("span", { className: "text-[11px] font-semibold text-white", children: ["Built by", " ", _jsx("span", { style: { color: "#f59e0b" }, className: "text-[13px] font-bold", children: "Kateb Tech" })] })] })] }));
};
