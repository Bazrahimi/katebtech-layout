 ...
 */
const toDataUrl = (value) => `data:image/svg+xml;charset=utf-8,${encodeURIComponent(value)}`;
/**
 ...
 */
export const getBlurDataURL = (width = 160, height = 160) => toDataUrl(shimmer(width, height));
/**
